...
# If nothing selected -> all months
    ...
    fig_rv1 = make_timeseries_figure(filtered_conv1, months_selected, 'rv_3_year', "RV 3 Year Over Time (Deal Closed Date)", "RV 3 Year", value_type="rupee")
    fig_app_rate  = make_timeseries_figure(filtered_app_rate, months_selected, 'appointment_rate', "Leads → Appointment Rate", "Appointment Rate", value_type="percent")
    fig_deal_rate = make_timeseries_figure(filtered_deal_rate, months_selected, 'deal_rate', "Appointment → Deal Rate", "Deal Rate", value_type="percent")
    fig_nib = make_timeseries_figure(filtered_nib_rate, months_selected, 'NIB_Rate', "NIB Rate", "NIB Rate", value_type="percent")
    fig_ni  = make_timeseries_figure(filtered_ni_rate, months_selected, 'NI_Rate', "NI Rate", "NI Rate", value_type="percent")
    fig_bad_dispo = make_timeseries_figure(filtered_bad_dispo_rate, months_selected, 'Bad_Dispo_Rate', "Bad Disposition Rate", "Bad Disposition Rate", value_type="percent")
    fig_rv_lead_rate = make_timeseries_figure(filtered_rv_lead_rate, months_selected, 'RV_Lead_Rate', "3 Year RV Per Lead", "3 Year RV Per Lead", value_type="rupee")
    fig_attempt = make_timeseries_figure(filtered_attempt_rate, months_selected, 'attempt_rate', "Attempt Rate", "Attempt Rate", value_type="percent")
    fig_call_scheduling = make_timeseries_figure(filtered_call_scheduling_rate, months_selected, 'call_scheduling_rate', "Call Scheduling Rate", "Call Scheduling Rate", value_type="percent")
    fig_conn = make_timeseries_figure(filtered_connectivity, months_selected, 'conn_per', "Connectivity Rate", "Connectivity Rate", value_type="percent")
